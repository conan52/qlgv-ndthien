...
{
    public partial class List_TonGiao : Form
    {
        public List_TonGiao()
        {
            InitializeComponent();
        ...
        void CreateViewItemsColumn()
        {
            viewItems.AddColumns(new NDThienDataGridViewColumn[] 
            {
                ...
                new NDThienDataGridViewColumn("Tên tôn giáo", 250, NDThienDataGridViewColumnStyle.ReadOnly, NDThienDataGridViewColumnDataType.String),
            });
        }
        ...
        void PopulateViewItems()
        {
            try
            {
                ...
                DataTable dt = SQLiteUtils.GetTable("select * from TonGiao");
                int i = 1;
        ...
        private void List_TonGiao_Load(object sender, EventArgs e)
        {
        ...
        private void btDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int isSuccess = SQLiteUtils.ExcuteNonQuery("delete from TonGiao where id=@id","@id", id);
