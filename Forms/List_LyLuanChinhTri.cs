    ...
    public partial class List_LyLuanChinhTri : Form
    {
        ...
        void CreateViewItemsColumn()
        {
            viewItems.AddColumns(new NDThienDataGridViewColumn[] 
            {
                ...
                new NDThienDataGridViewColumn("Mã", 250, NDThienDataGridViewColumnStyle.ReadOnly, NDThienDataGridViewColumnDataType.String),
                new NDThienDataGridViewColumn("Tên trình độ lý luận chính trị", 250, NDThienDataGridViewColumnStyle.ReadOnly, NDThienDataGridViewColumnDataType.String),
            });
        }
        ...
        private void btEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var addDM = new Add_LyLuanChinhTri();
                addDM.ID = id;
                addDM.Text = "Sửa lý luận chính trị";
